...
namespace KhoDuoc
{
    public partial class ChiTietLinhF : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into chiTietLinh values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "',)";
            cmd.ExecuteNonQuery();
            con.Close();
            textBox1.Text = "";
            textBox2.Text = "";
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update thuoc set slyc='" + textBox3.Text + "' where sophieu='" + textBox1.Text + "',mathuoc ='"+textBox2.Text+"'";
            cmd.ExecuteNonQuery();
            con.Close();
            disp_data();
        ...
        private void ChiTietLinhF_Load(object sender, EventArgs e)
        {
            disp_data();
